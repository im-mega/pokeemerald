...
const u16 gMetatiles_exterior_green[] = INCBIN_U16("data/tilesets/primary/exterior_green/metatiles.bin");
const u16 gMetatileAttributes_exterior_green[] = INCBIN_U16("data/tilesets/primary/exterior_green/metatile_attributes.bin");
